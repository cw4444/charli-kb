...
- [Optimism](concepts/optimism.md): future-oriented cognitive style tied to ACC/IFG neuroimaging signals, optimism-bias structure, dopamine-modulated bad-news updating, expectancy-guided attention, salience/executive-control network evidence, embodied/lateralization hypotheses, vivid positive simulation, attributional optimism, flexible optimism, attention-bias modification caveats, trainable best-possible-self imagery, selective updating, pessimism as context-sensitive expectancy, placebo sleep, agency, opportunity attention, counterfactual gratitude, sleep-health associations, and observational cardiovascular/longevity evidence.
