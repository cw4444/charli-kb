...
- [Optimism Neuroscience Source Batch](sources/optimism-neuroscience-source-batch.md): public-source research note on optimism bias, pessimism, future simulation, belief updating, best-possible-self imagery, placebo sleep, repetitive negative thinking, agency, embodiment, and sleep/insomnia associations.
...
- [AI And Agents 2026 Timeline](timelines/ai-and-agents-2026.md): lightweight historical timeline for the fast-moving 2026 AI/agent acceleration, including agent security infrastructure, Anthropic's offensive-cyber analysis, EU technological sovereignty, major lab strategy, cooperation/governance framing, workplace rearchitecture, governance, and model-character signals.
...
- [Optimism](concepts/optimism.md): future-oriented cognitive style tied to ACC/IFG neuroimaging signals, vivid positive simulation, attributional optimism, trainable best-possible-self imagery, selective updating, pessimism as context-sensitive expectancy, placebo sleep, agency, opportunity attention, counterfactual gratitude, and sleep-health associations.
