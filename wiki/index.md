...
- [Agent Security Infrastructure 2026](sources/agent-security-infrastructure-2026.md): source note on GitHub Copilot sandboxes, Microsoft's ASSERT and Agent Control Specification, Anthropic's AI-enabled cyber-threat analysis, and why agent controls are becoming infrastructure.
...
- [AI And Agents 2026 Timeline](timelines/ai-and-agents-2026.md): lightweight historical timeline for the fast-moving 2026 AI/agent acceleration, including agent security infrastructure, Anthropic's offensive-cyber analysis, EU technological sovereignty, major lab strategy, workplace rearchitecture, governance, and model-character signals.
