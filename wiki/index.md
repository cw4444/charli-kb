...
- [Neuroscience](../themes/neuroscience/overview.md): front door for the wiki's neuroscience lane, connecting perception, imagination, belief updating, agency, brain-computer interfaces, embodied action control, cellular maintenance, and neurodegeneration.
...
- [OpenAI Third Phase Strategy 2026](sources/openai-third-phase-strategy-2026.md): source note on OpenAI's June 2026 strategy cluster: automated AI research, "personal AGI" distribution, confidential draft S-1 optionality, economic-impact research, and international coordination language.
...
- [Optimism](concepts/optimism.md): future-oriented cognitive style tied to ACC/IFG neuroimaging signals, optimism-bias structure, dopamine-modulated bad-news updating, optimistic reinforcement learning, prior-cue utilisation, pessimistic anticipation under uncertainty, active-inference simulation, right-frontal gamma-tACS preprint evidence, expectancy-guided attention, attention-bias modification training, salience/executive-control network evidence, embodied/lateralization hypotheses, vivid positive simulation, attributional optimism, flexible optimism, trainable best-possible-self imagery, selective updating, pessimism as context-sensitive expectancy, placebo sleep, agency, opportunity attention, counterfactual gratitude, sleep-health associations, and observational cardiovascular/longevity evidence.
