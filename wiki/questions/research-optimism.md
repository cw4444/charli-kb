...
Shah's 2012 Frontiers commentary is useful here because it refuses to let the Sharot line float away on its own attractiveness. Shah treats the neuroscience turn as promising, but keeps the methodological caveat alive: older comparison-based optimism-bias work had been challenged as artifact-prone, and newer belief-update methods still need careful testing, especially when they use only negative future events. That makes it a good counterweight source. The safe claim is not "Sharot settled optimism bias." The safe claim is "Sharot opened a mechanism route that still needs measurement discipline."
...
One adjacent paper needs keeping out of the same bucket with a cattle prod. Bem's 2011 *Feeling the Future* claimed that later random events could alter already-recorded cognitive or affective responses. That is a precognition claim, not future-self work: Best Possible Self imagery is a present mental practice affecting later outlook and behaviour through ordinary causal routes. Three preregistered close replications of Bem's retroactive-recall experiment were null, and the ensuing statistical dispute became a useful replication-crisis case study. The practical rule remains gloriously unromantic: future imagery may alter attention, appraisal, and action; it does not establish that a desired future reaches backward to arrange the present. See [Optimism Neuroscience Source Batch](../sources/optimism-neuroscience-source-batch.md).
...
### 6. Fast optimism may be the first pass; realism needs time and actual world knowledge

Sjåstad and Baumeister 2023 directly manipulated response mode across five experiments (United States and Norway; combined N = 3,213). People assigned to fast, time-pressured intuition made more optimistic predictions about their own future than people asked to reflect after a delay. The difference appeared in comparative event predictions, health-risk estimates, and a binary forecast about establishing a daily exercise habit; it was specific to forecasts about oneself rather than the average person in the self-versus-other comparison.

Their proposed two-step model is a good fit for the rest of this package: the first pass imagines what one wants, and a later pass examines obstacles and likelihood. But the later pass is not automatically more accurate. In the exercise study, reflection reduced optimistic forecasts only among participants with reasonably accurate beliefs about the base rate of daily exercise. Slow thought can integrate useful facts; it can also slowly polish a bad prior. The paper uses comparative-optimism measures cautiously, and its strongest realism claim belongs to that final base-rate-linked experiment, not the whole set.

### 7. Repetitive negative thinking looks like an opposing process
...
### 8. Positive illusions are relevant, but they are not a free pass for bullshit
...
### 9. Optimism matters when it supports agency
...
Adjacent constructs fill in the pivot-after-bad-news part. Block and Kremen's ego-resiliency points to flexible adaptation after disruption. Kobasa's hardiness points to commitment, control, and challenge under stress. Fredrickson's broaden-and-build theory and Tugade and Fredrickson's resilience work suggest that positive emotion can widen available thought-action options and help recovery after negative experience. The caveat is doing grown-up work here: this is not proof that positive people are always accurate, safer, healthier, or better decision-makers. It is a source-backed way to talk about default future expectancy and fast recovery without laundering it through manifestation.
...
### 10. "Luck" may partly be an attentional style
...
### 11. Attention training is plausible, but the simple trait link did not show up
...
Morton, El-Deredy, Morton, Elliott, and Jones 2011 adds a slightly earlier top-down cue result. Participants judged happy, sad, and fearful facial-expression images after verbal cues predicted the expression and intensity. The cues could match the image, be slightly wrong, or be very wrong. Dispositional optimism correlated with acquiescence to the cue across discrepancy levels, which the authors interpret as optimistic people leaning more on prior expectations and taking longer to recognize mismatch with incoming information.
...
### 12. Pessimist gratitude counts avoided bad outcomes
...
### 13. Body perturbation can shift optimism bias
...
### 14. Optimism is linked with lower insomnia risk, but the causal arrow is not settled
...
### 15. Placebo sleep shows that sleep beliefs can affect some cognitive performance
...
### 16. Optimism is associated with cardiovascular and longevity outcomes
...
### 17. Unknown emotional valence can be processed like potential threat
...
- fast personal prediction that is more optimistic under time pressure, followed by a reflective stage that can incorporate obstacles and accurate base rates
...
- Sjåstad and Baumeister, [Fast optimism, slow realism? Causal evidence for a two-step model of future thinking](https://doi.org/10.1016/j.cognition.2023.105447), *Cognition* (2023).
