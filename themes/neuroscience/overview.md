...
This is the front door for the wiki's neuroscience lane.

The lane exists because the brain is not merely a source of interesting metaphors for reality, agency, or AI. It is a physical system that builds experience, predicts, imagines, remembers, moves, transports cargo, responds to stress, and sometimes fails in ways that reveal the machinery.

Charli's working description is fair:

> Neuroscience is quantum mechanics for custard brains.

The joke works because both fields punish common-sense stories. The caveat matters more: neuroscience and quantum mechanics are not the same discipline, and brain findings do not settle quantum foundations.

## Why This Lane Exists

The repo already contains a substantial neuroscience thread, but it has been scattered across the reality and optimism lanes:
...
### How Does The Brain Build Experience?
...
- A mouse result is not a human treatment.
